                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/general.update profile')}} </h4>
                                        ...
                                        <form class="form" action="{{route('update.profile')}}"
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput2">{{__('admin/general.email')}} </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> {{__('admin/general.confirm password')}}   </label>
                                                        <input type="password" value="" id=""
                                                               class="form-control"
                                                               placeholder=""
